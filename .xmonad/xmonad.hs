...
myKeys =
    -- Xmonad
        ...
        , ("M-S-l", spawn "i3lock")              -- Lock the display

    -- Run Prompts
        , ("M1-r", spawn "dmenu_run -i -p \"Run: \"") -- Dmenu
        , ("M1-<Space>", spawn "j4-dmenu-desktop --no-generic --dmenu=\"dmenu -i -p 'Launch: '\" --term='alacritty'")
    ...
    -- Scripts (Ctrl + Alt keys)
        , ("M1-C-e", spawn "$HOME/scripts/dmenu/dmenu-edit-configs.sh")
        , ("M1-C-v", spawn "$HOME/scripts/dmenu/dmenu-show-vmssh")
        , ("M1-C-w", spawn "$HOME/scripts/dmenu/dmenu-set-wallpaper.sh")
        , ("M1-C-s", spawn "$HOME/scripts/wallpaper/safe_wallpaper.sh")

    -- Layouts
        , ("M-<Tab>", sendMessage NextLayout)           -- Switch to next layout
        , ("M-<Space>", sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts) -- Toggles noborder/full
        , ("M-S-l", sendMessage Expand)            -- expand master area
        , ("M-S-h", sendMessage Shrink)            -- shrink master area
